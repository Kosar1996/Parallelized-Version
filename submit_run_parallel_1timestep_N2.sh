...
#SBATCH --output=logs/run_parallel_1timestep_N2_%j.out
#SBATCH --error=logs/run_parallel_1timestep_N2_%j.err
...
echo "Script: run_parallel_1timestep.m, NUM_PROCS=2"
echo "=================================================="
