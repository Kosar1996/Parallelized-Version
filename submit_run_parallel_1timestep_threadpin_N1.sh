...
#SBATCH --output=logs/run_parallel_1timestep_threadpin_N1_%j.out
#SBATCH --error=logs/run_parallel_1timestep_threadpin_N1_%j.err
...
echo "Script: run_parallel_1timestep_threadpin.m, NUM_PROCS=1 (thread-pinning diagnostic)"
echo "=================================================="
