...
%   profile_report_1timestep_5hr/   HTML profiler report (profsave)
%   profile_data_1timestep_5hr.mat  raw profile struct, for later inspection
%   out_profile_1timestep_5hr.mat   solver output (out struct)
...
pInfo = profile('info');
save('profile_data_1timestep_5hr.mat', 'pInfo', 'wallClockSeconds');
profsave(pInfo, 'profile_report_1timestep_5hr');

out.cfg = cfg;
save('out_profile_1timestep_5hr.mat', 'out', 'wallClockSeconds');

fprintf('\nSaved: profile_data_1timestep_5hr.mat, profile_report_1timestep_5hr/, out_profile_1timestep_5hr.mat\n');
