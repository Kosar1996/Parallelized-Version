...
#SBATCH --output=logs/run_parallel_1timestep_N8_%j.out
#SBATCH --error=logs/run_parallel_1timestep_N8_%j.err
...
echo "Script: run_parallel_1timestep.m, NUM_PROCS=8"
echo "=================================================="
