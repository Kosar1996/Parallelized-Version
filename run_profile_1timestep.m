...
%   profile_report_1timestep/   HTML profiler report (profsave)
%   profile_data_1timestep.mat  raw profile struct, for later inspection
%   out_profile_1timestep.mat   solver output (out struct)
...
pInfo = profile('info');
save('profile_data_1timestep.mat', 'pInfo', 'wallClockSeconds');
profsave(pInfo, 'profile_report_1timestep');

out.cfg = cfg;
save('out_profile_1timestep.mat', 'out', 'wallClockSeconds');

fprintf('\nSaved: profile_data_1timestep.mat, profile_report_1timestep/, out_profile_1timestep.mat\n');
