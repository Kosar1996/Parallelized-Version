...
#SBATCH --output=logs/run_parallel_1timestep_N4_%j.out
#SBATCH --error=logs/run_parallel_1timestep_N4_%j.err
...
echo "Script: run_parallel_1timestep.m, NUM_PROCS=4"
echo "=================================================="
