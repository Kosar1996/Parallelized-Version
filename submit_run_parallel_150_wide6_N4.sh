...
#SBATCH --output=logs/run_parallel_150_wide6_N4_%j.out
#SBATCH --error=logs/run_parallel_150_wide6_N4_%j.err
...
echo "Script: run_parallel_150_wide6.m, NUM_PROCS=4"
echo "=================================================="
